...
9. refresh provider leases in the availability directory
10. fetch enough shards back from provider records
11. reconstruct ciphertext
12. decrypt exactly to the original plaintext
