...
| Sybil peers | Durability | Creates many PeerIDs | Fake independent storage | Qualified operators, failure-domain policy | Early network bootstrap weakness | Reputation/audit correlation | Exclude unqualified peers, repair |
